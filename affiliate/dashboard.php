<?php if(empty($link)){header('Location: ./admin.php'); exit;} ?><!doctype html><html><head><meta charset="utf-8"><title>Admin | Affiliate Me - <?php echo $version; ?></title><link href="font-awesome.min.css" rel="stylesheet"><link href="dashboard.css" rel="stylesheet"><script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js"></script><script src="jquery-1.12.4.min.js"></script></head><body><div id="container"><div id="Layer7"><div id="wb_FontAwesomeIcon3"><div id="FontAwesomeIcon3"><i class="fa fa-bar-chart"></i></div></div><div id="Html6"><?php
...
var chart=AmCharts.makeChart("chartdiv",{"theme":"dark","type":"serial","dataProvider":[{"month":"JAN","sales":"<?php echo $m1;?>","visits":"<?php echo $v1;?>"},{"month":"FEB","sales":"<?php echo $m2;?>","visits":"<?php echo $v2;?>"},{"month":"MAR","sales":"<?php echo $m3;?>","visits":"<?php echo $v3;?>"},{"month":"APR","sales":"<?php echo $m4;?>","visits":"<?php echo $v4;?>"},{"month":"MAY","sales":"<?php echo $m5;?>","visits":"<?php echo $v5;?>"},{"month":"JUN","sales":"<?php echo $m6;?>","visits":"<?php echo $v6;?>"},{"month":"JUL","sales":"<?php echo $m7;?>","visits":"<?php echo $v7;?>"},{"month":"AUG","sales":"<?php echo $m8;?>","visits":"<?php echo $v8;?>"},{"month":"SEP","sales":"<?php echo $m9;?>","visits":"<?php echo $v9;?>"},{"month":"OCT","sales":"<?php echo $m10;?>","visits":"<?php echo $v10;?>"},{"month":"NOV","sales":"<?php echo $m11;?>","visits":"<?php echo $v11;?>"},{"month":"DEC","sales":"<?php echo $m12;?>","visits":"<?php echo $v12;?>"}],"valueAxes":[{"unit":"","position":"left","title":"<?php echo $lang['annvis'];?>",}],"startDuration":1,"graphs":[{"balloonText":"<?php echo $lang['viscon'];?> [[category]] (<?php echo $lang['affsale'];?>): <b>[[value]]</b>","fillColors":"#4FA7FF","fillAlphas":0.6,"lineAlpha":0.2,"title":"sales","type":"column","valueField":"sales"},{"balloonText":"<?php echo $lang['normvis'];?> [[category]] (<?php echo $lang['affclicks'];?>): <b>[[value]]</b>","fillColors":"#4FA7FF","fillAlphas":0.9,"lineAlpha":0.2,"title":"visits","type":"column","clustered":false,"columnWidth":0.5,"valueField":"visits"}],"categoryField":"month","categoryAxis":{"gridPosition":"start"},"export":{"enabled":false}});</script><!-- HTML --><div id="chartdiv"></div></div><div id="Html18"><span style="color:#D3D3D3;font-family:Arial;font-size:16px;"><?php echo $lang['refstats'];?></span></div></div><div id="Layer2"><div id="Html15"><?php
...
var data=[['fo',<?php echo $c1;?>],['um',<?php echo $c2;?>],['us',<?php echo $c3;?>],['jp',<?php echo $c4;?>],['sc',<?php echo $c5;?>],['in',<?php echo $c6;?>],['fr',<?php echo $c7;?>],['fm',<?php echo $c8;?>],['cn',<?php echo $c9;?>],['pt',<?php echo $c10;?>],['sw',<?php echo $c11;?>],['sh',<?php echo $c12;?>],['br',<?php echo $c13;?>],['ki',<?php echo $c14;?>],['ph',<?php echo $c15;?>],['mx',<?php echo $c16;?>],['es',<?php echo $c17;?>],['bu',<?php echo $c18;?>],['mv',<?php echo $c19;?>],['sp',<?php echo $c20;?>],['gb',<?php echo $c21;?>],['gr',<?php echo $c22;?>],['as',<?php echo $c23;?>],['dk',<?php echo $c24;?>],['gl',<?php echo $c25;?>],['gu',<?php echo $c26;?>],['mp',<?php echo $c27;?>],['pr',<?php echo $c28;?>],['vi',<?php echo $c29;?>],['ca',<?php echo $c30;?>],['st',<?php echo $c31;?>],['cv',<?php echo $c32;?>],['dm',<?php echo $c33;?>],['nl',<?php echo $c34;?>],['jm',<?php echo $c35;?>],['ws',<?php echo $c36;?>],['om',<?php echo $c37;?>],['vc',<?php echo $c38;?>],['tr',<?php echo $c39;?>],['bd',<?php echo $c40;?>],['lc',<?php echo $c41;?>],['nr',<?php echo $c42;?>],['no',<?php echo $c43;?>],['kn',<?php echo $c44;?>],['bh',<?php echo $c45;?>],['to',<?php echo $c46;?>],['fi',<?php echo $c47;?>],['id',<?php echo $c48;?>],['mu',<?php echo $c49;?>],['se',<?php echo $c50;?>],['tt',<?php echo $c51;?>],['my',<?php echo $c52;?>],['pa',<?php echo $c53;?>],['pw',<?php echo $c54;?>],['tv',<?php echo $c55;?>],['mh',<?php echo $c56;?>],['cl',<?php echo $c57;?>],['th',<?php echo $c58;?>],['gd',<?php echo $c59;?>],['ee',<?php echo $c60;?>],['ag',<?php echo $c61;?>],['tw',<?php echo $c62;?>],['bb',<?php echo $c63;?>],['it',<?php echo $c64;?>],['mt',<?php echo $c65;?>],['vu',<?php echo $c66;?>],['sg',<?php echo $c67;?>],['cy',<?php echo $c68;?>],['lk',<?php echo $c69;?>],['km',<?php echo $c70;?>],['fj',<?php echo $c71;?>],['ru',<?php echo $c72;?>],['va',<?php echo $c73;?>],['sm',<?php echo $c74;?>],['kz',<?php echo $c75;?>],['az',<?php echo $c76;?>],['tj',<?php echo $c77;?>],['ls',<?php echo $c78;?>],['uz',<?php echo $c79;?>],['ma',<?php echo $c80;?>],['co',<?php echo $c81;?>],['tl',<?php echo $c82;?>],['tz',<?php echo $c83;?>],['ar',<?php echo $c84;?>],['sa',<?php echo $c85;?>],['pk',<?php echo $c86;?>],['ye',<?php echo $c87;?>],['ae',<?php echo $c88;?>],['ke',<?php echo $c89;?>],['pe',<?php echo $c90;?>],['do',<?php echo $c91;?>],['ht',<?php echo $c92;?>],['pg',<?php echo $c93;?>],['ao',<?php echo $c94;?>],['kh',<?php echo $c95;?>],['vn',<?php echo $c96;?>],['mz',<?php echo $c97;?>],['cr',<?php echo $c98;?>],['bj',<?php echo $c99;?>],['ng',<?php echo $c100;?>],['ir',<?php echo $c101;?>],['sv',<?php echo $c102;?>],['sl',<?php echo $c103;?>],['gw',<?php echo $c104;?>],['hr',<?php echo $c105;?>],['bz',<?php echo $c106;?>],['za',<?php echo $c107;?>],['cf',<?php echo $c108;?>],['sd',<?php echo $c109;?>],['cd',<?php echo $c110;?>],['kw',<?php echo $c111;?>],['de',<?php echo $c112;?>],['be',<?php echo $c113;?>],['ie',<?php echo $c114;?>],['kp',<?php echo $c115;?>],['kr',<?php echo $c116;?>],['gy',<?php echo $c117;?>],['hn',<?php echo $c118;?>],['mm',<?php echo $c119;?>],['ga',<?php echo $c120;?>],['gq',<?php echo $c121;?>],['ni',<?php echo $c122;?>],['lv',<?php echo $c123;?>],['ug',<?php echo $c124;?>],['mw',<?php echo $c125;?>],['am',<?php echo $c126;?>],['sx',<?php echo $c127;?>],['tm',<?php echo $c128;?>],['zm',<?php echo $c129;?>],['nc',<?php echo $c130;?>],['mr',<?php echo $c131;?>],['dz',<?php echo $c132;?>],['lt',<?php echo $c133;?>],['et',<?php echo $c134;?>],['er',<?php echo $c135;?>],['gh',<?php echo $c136;?>],['si',<?php echo $c137;?>],['gt',<?php echo $c138;?>],['ba',<?php echo $c139;?>],['jo',<?php echo $c140;?>],['sy',<?php echo $c141;?>],['mc',<?php echo $c142;?>],['al',<?php echo $c143;?>],['uy',<?php echo $c144;?>],['cnm',<?php echo $c145;?>],['mn',<?php echo $c146;?>],['rw',<?php echo $c147;?>],['so',<?php echo $c148;?>],['bo',<?php echo $c149;?>],['cm',<?php echo $c150;?>],['cg',<?php echo $c151;?>],['eh',<?php echo $c152;?>],['rs',<?php echo $c153;?>],['me',<?php echo $c154;?>],['tg',<?php echo $c155;?>],['la',<?php echo $c156;?>],['af',<?php echo $c157;?>],['ua',<?php echo $c158;?>],['sk',<?php echo $c159;?>],['jk',<?php echo $c160;?>],['bg',<?php echo $c161;?>],['qa',<?php echo $c162;?>],['li',<?php echo $c163;?>],['at',<?php echo $c164;?>],['sz',<?php echo $c165;?>],['hu',<?php echo $c166;?>],['ro',<?php echo $c167;?>],['ne',<?php echo $c168;?>],['lu',<?php echo $c169;?>],['ad',<?php echo $c170;?>],['ci',<?php echo $c171;?>],['lr',<?php echo $c172;?>],['bn',<?php echo $c173;?>],['iq',<?php echo $c174;?>],['ge',<?php echo $c175;?>],['gm',<?php echo $c176;?>],['ch',<?php echo $c177;?>],['td',<?php echo $c178;?>],['kv',<?php echo $c179;?>],['lb',<?php echo $c180;?>],['dj',<?php echo $c181;?>],['bi',<?php echo $c182;?>],['sr',<?php echo $c183;?>],['il',<?php echo $c184;?>],['ml',<?php echo $c185;?>],['sn',<?php echo $c186;?>],['gn',<?php echo $c187;?>],['zw',<?php echo $c188;?>],['pl',<?php echo $c189;?>],['mk',<?php echo $c190;?>],['py',<?php echo $c191;?>],['by',<?php echo $c192;?>],['cz',<?php echo $c193;?>],['bf',<?php echo $c194;?>],['na',<?php echo $c195;?>],['ly',<?php echo $c196;?>],['tn',<?php echo $c197;?>],['bt',<?php echo $c198;?>],['md',<?php echo $c199;?>],['ss',<?php echo $c200;?>],['bw',<?php echo $c201;?>],['bs',<?php echo $c202;?>],['nz',<?php echo $c203;?>],['cu',<?php echo $c204;?>],['ec',<?php echo $c205;?>],['au',<?php echo $c206;?>],['ve',<?php echo $c207;?>],['sb',<?php echo $c208;?>],['mg',<?php echo $c209;?>],['is',<?php echo $c210;?>],['eg',<?php echo $c211;?>],['kg',<?php echo $c212;?>],['np',<?php echo $c213;?>]];Highcharts.mapChart('container1',{chart:{map:'custom/world',backgroundColor:'rgba(255, 255, 255, 0.0)'},title:{text:'<span style="color:#FFFFFF;font-family:Arial;font-size:15px;"><?php echo $lang['map'];?></span>'},mapNavigation:{enabled:true,buttonOptions:{verticalAlign:'bottom'}},colorAxis:{min:0},series:[{data:data,name:'Affiliates',states:{hover:{color:'#BADA55'}},dataLabels:{enabled:false,format:'{point.name}'}}]});</script></div></div><div id="Layer8"><div id="Html4"><script src="https://www.amcharts.com/lib/3/amcharts.js"></script><script src="https://www.amcharts.com/lib/3/gauge.js"></script><script src="https://www.amcharts.com/lib/3/themes/dark.js"></script><script>
var clock=AmCharts.makeChart("time",{"type":"gauge","theme":"dark","startDuration":0.5,"marginTop":30,"marginBottom":30,"axes":[{"axisAlpha":0.3,"endAngle":360,"endValue":12,"minorTickInterval":0.2,"showFirstLabel":false,"startAngle":0,"axisThickness":10,"valueInterval":1}],"arrows":[{"radius":"50%","innerRadius":0,"clockWiseOnly":true,"nailRadius":10,"nailAlpha":1},{"nailRadius":0,"radius":"80%","startWidth":6,"innerRadius":0,"clockWiseOnly":true},{"color":"#CC0000","nailRadius":4,"startWidth":3,"innerRadius":0,"clockWiseOnly":true,"nailAlpha":1}],"export":{"enabled":false}});var start=<?php echo time();?>;setInterval(updateClock,1000);function updateClock(){if(clock.arrows.length>0){start++;var estTime=new Date(start*1000);var date=new Date(estTime.toLocaleString('en-US',{timeZone:'<?php echo date_default_timezone_get(); ?>'}));var hours=date.getHours();var minutes=date.getMinutes();var seconds=date.getSeconds();if(clock.arrows[0].setValue){clock.arrows[0].setValue(hours+minutes/60);clock.arrows[1].setValue(12*(minutes+seconds/60)/60);clock.arrows[2].setValue(12*date.getSeconds()/60);}}}</script><div id="time"></div></div><div id="Html9"><?php echo "<span style=\"color:#C0C0C0;font-family:Arial;font-size:12px;\">".$lang['timezone'].": <strong>".date_default_timezone_get()."</strong></span>"; ?></div><div id="Html19"><div style="color:#D3D3D3;font-family:Arial;font-size:15px;text-align:center;"><?php echo $lang['apptime'];?></div></div></div><div id="Html23"><div style="color:#A9A9A9;font-family:Arial;font-size:13px; text-align:center;">Affiliate Me Version <?php echo $version; ?><br></div></div><div id="Layer1" onclick="window.location.href='admin.php?show=users';return false;" class="enable"><div id="wb_usersicon"><div id="usersicon"><i class="fa fa-users"></i></div></div><div id="Html1"><div class="count" style="color:#FFFFFF;font-family:Arial;font-size:45px;"><?php  echo $users;  ?></div></div><div id="Html16"><span style="color:#C0C0C0;font-family:Arial;font-size:18px;"><?php echo $lang['affonline'];?> (<span class="count"><?php  echo $usersonline;  ?></span>)</span></div><hr id="Line1"><div id="Html11"><span style="color:#C0C0C0;font-family:Arial;font-size:16px;"><?php echo $lang['sysaff'];?></span></div></div><div id="Layer3" onclick="window.location.href='admin.php?show=users';return false;" class="enable"><hr id="Line2"><div id="wb_adminsicon"><div id="adminsicon"><i class="fa fa-users"></i></div></div><div id="Html2"><div class="count" style="color:#FFFFFF;font-family:Arial;font-size:45px;"><?php  echo $admins;  ?></div></div><div id="Html3"><span style="color:#C0C0C0;font-family:Arial;font-size:18px;"><?php echo $lang['admonline'];?> (<span class="count"><?php  echo $adminsonline;  ?></span>)</span></div><div id="Html13"><span style="color:#C0C0C0;font-family:Arial;font-size:16px;"><?php echo $lang['admins'];?></span></div></div><div id="Layer4" onclick="window.location.href='admin.php?show=req';return false;" class="enable"><hr id="Line3"><div id="wb_payouticon"><div id="payouticon"><i class="fa fa-paypal"></i></div></div><div id="Html5"><div class="count" style="color:#FFFFFF;font-family:Arial;font-size:45px;"><?php  echo $nreq;  ?></div></div><div id="Html7"><span style="color:#C0C0C0;font-family:Arial;font-size:18px;"><?php echo $lang['tpays'];?> (<span class="count"><?php  echo $payout;  ?></span>)</span></div><div id="Html14"><span style="color:#C0C0C0;font-family:Arial;font-size:16px;"><?php echo $lang['nreq'];?></span></div></div><div id="Layer9" onclick="window.location.href='admin.php?show=tickets';return false;" class="enable"><hr id="Line4"><div id="wb_ticketicon"><div id="ticketicon"><i class="fa fa-comments"></i></div></div><div id="Html8"><div class="count" style="color:#FFFFFF;font-family:Arial;font-size:45px;"><?php  echo $msg;  ?></div></div><div id="Html10"><span style="color:#C0C0C0;font-family:Arial;font-size:18px;"><?php echo $lang['tticks'];?> (<span class="count"><?php  echo $tickets;  ?></span>)</span></div><div id="Html17"><span style="color:#C0C0C0;font-family:Arial;font-size:16px;"><?php echo $lang['ntickmess'];?></span></div></div><div id="Layer5"><div id="wb_FontAwesomeIcon4"><div id="FontAwesomeIcon4"><i class="fa fa-pie-chart"></i></div></div><div id="Html20"><span style="color:#D3D3D3;font-family:Arial;font-size:15px;"><?php echo $lang['convsale'];?></span></div><div id="Html12"><?php echo "<div style=\"color:#C0C0C0;font-size:12px;text-align:center\">".$lang['recfor']." <strong>".date('F')." ".$year."</strong></div>"; ?></div></div><div id="Layer6"><div id="wb_FontAwesomeIcon1"><div id="FontAwesomeIcon1"><i class="fa fa-line-chart"></i></div></div><div id="Html22"><span style="color:#D3D3D3;font-family:Arial;font-size:16px;"><?php echo $lang['sinsight'];?></span></div><div id="sechtml"><?php
$day="";
$vl="";
$vls="";
// Attempt select query execution
...
$sql = "SELECT *, COUNT(FROM_UNIXTIME(`TIME`, '%Y-%m-%d')) AS dt, (FROM_UNIXTIME(`TIME`, '%M-%d')) AS m FROM  ref WHERE (FROM_UNIXTIME(`TIME`, '%Y-%m-%d') = '".$dt."') GROUP BY (FROM_UNIXTIME(`TIME`, '%Y-%m-%d'))";
...
//Checking for sales
$sqls = "SELECT *, COUNT(FROM_UNIXTIME(`TIME`, '%Y-%m-%d')) AS dts, (FROM_UNIXTIME(`TIME`, '%M-%d')) AS ms FROM  ref WHERE SALE = 'yes' && (FROM_UNIXTIME(`TIME`, '%Y-%m-%d') = '".$dt."') GROUP BY (FROM_UNIXTIME(`TIME`, '%Y-%m-%d'))";
...
var xValues=[<?php echo $day;?>];new Chart("myChart",{type:"line",data:{labels:xValues,datasets:[{label:'Clicks',data:[<?php echo $vl;?>],backgroundColor:"rgba(30,144,255,0.3)",borderColor:"#48a4fd",fill:true},{label:'Sales',data:[<?php echo $vls;?>],backgroundColor:"rgba(50,205,50,0.3)",borderColor:"limegreen",fill:true}]},options:{legend:{display:false},responsive:true,maintainAspectRatio:false,scales:{xAxes:[{display:true,gridLines:{display:true,color:"#454751"},scaleLabel:{display:true,}}],yAxes:[{display:true,gridLines:{display:true,color:"#454751"},scaleLabel:{display:true,}}]}}});Chart.defaults.global.defaultFontColor="#F5F5F5";</script></div></div><iframe name="dough" id="InlineFrame1" src="doughnut.php" scrolling="no">Loading Chart</iframe></div><script>
$('.count').each(function(){$(this).prop('Counter',0).animate({Counter:$(this).text()},{duration:5000,easing:'swing',step:function(now){var formattedValue=nFormatter(Math.ceil(now),1);$(this).text(formattedValue);}});});function nFormatter(num,digits){const si=[{value:1,symbol:""},{value:1E3,symbol:"K"},{value:1E6,symbol:"M"},{value:1E9,symbol:"G"},{value:1E12,symbol:"T"},{value:1E15,symbol:"P"},{value:1E18,symbol:"E"}];const rx=/\.0+$|(\.[0-9]*[1-9])0+$/;let i;for(i=si.length-1;i>0;i--){if(num>=si[i].value){break;}}
return(num/si[i].value).toFixed(digits).replace(rx,"$1")+si[i].symbol;}</script></body></html>