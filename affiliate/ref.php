...
$user = mysqli_real_escape_string($link, str_replace($search, $replace, $_GET['ref']));
...
header("Location:$red");
mysqli_close($link);
?><!doctype html><html><head><meta charset="utf-8"><title><?php echo $sitename; ?></title><meta name="keywords" content="<?php echo $sitename; ?>"><meta name="robots" content="noindex, nofollow"><meta name="generator" content="Powerstone"><link href="ref.css" rel="stylesheet"></head><body><div id="container"></div></body></html><?php
ob_end_flush();
?>