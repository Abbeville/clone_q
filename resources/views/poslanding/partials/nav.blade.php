            ...
            <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
              <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
                ...
                <li class="nav-item dropdown dropdown-hover mx-2">
                 ...
                 <li class="nav-item dropdown dropdown-hover mx-2">
                  <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" data-scroll href="https://calendly.com/tappyqr/60min?month=2022-06"target="_blank" aria-expanded="false">Demo</a>             
                  </li>
